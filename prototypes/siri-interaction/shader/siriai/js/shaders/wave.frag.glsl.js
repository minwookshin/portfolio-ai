 ...
 * [OUTPUT]: WAVE_FRAGMENT_SHADER — Siri waveform pass (premultiplied RGBA)
 * [POS]: shaders/ 的声波层；4 次光谱采样的彩边波形，audio 三频段调制振幅/色散/填充
 * [PROTOCOL]: 变更时更新此头部，然后检查 AGENTS.md
 */

// ============================================================================
// Wave pass. Verbatim GLSL from the original siri27 bundle (author: xiaolin).
// Key ideas:
...
void main() {
	...
	//       flattens every overbright gradient into hard posterized bands
	//   1 — channel-wise clamp (bloom/Apple): hot cores saturate to white
	//       GRADUALLY as channels clip one by one — the soft blooming look
