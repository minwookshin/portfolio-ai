...
export const DESIGN_SYSTEM_TOKENS = {
  ...
  colors: [
    { role: "background.base", cssVariable: "--bg-base", value: "#FFFFFF", usage: "page canvas" },
    { role: "background.surface", cssVariable: "--bg-surface", value: "#FFFFFF", usage: "quiet panels and inputs" },
    { role: "background.element", cssVariable: "--bg-element", value: "#F4F4F5", usage: "resting underline, subtle UI fill, skeleton states" },
    { role: "border.light", cssVariable: "--border-light", value: "#E2E4E9", usage: "hairline structure only where needed" },
    { role: "text.primary", cssVariable: "--text-primary", value: "#000000", usage: "primary text and active links" },
    { role: "text.muted", cssVariable: "--text-muted", value: "#A1A1AA", usage: "metadata, secondary copy, timestamps" },
    { role: "text.underlineMuted", cssVariable: "--text-underline-muted", value: "#F4F4F5", usage: "resting link underline" },
    { role: "dark.background", cssVariable: "--dark-bg-base", value: "#08090A", usage: "embedded dark code/project surfaces" },
    { role: "dark.surface", cssVariable: "--dark-bg-surface", value: "#121314", usage: "embedded dark detail surfaces" },
  ],
  typography: {
    families: [
