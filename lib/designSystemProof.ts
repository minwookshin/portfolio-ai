...
export const DESIGN_SYSTEM_TOKENS = {
  ...
  colors: [
    ...
    { role: "theme.dark.background", cssVariable: "--theme-dark-bg", value: "#0F0F10", usage: "cretu.dev dark canvas" },
    { role: "theme.dark.surface", cssVariable: "--theme-dark-surface", value: "#18181B", usage: "quiet dark panels and inputs" },
    { role: "theme.dark.element", cssVariable: "--theme-dark-element", value: "#1C1C1F", usage: "subtle dark fills and code surfaces" },
    { role: "theme.dark.ink", cssVariable: "--theme-dark-ink", value: "#ECECEF", usage: "dark mode primary text" },
    { role: "theme.dark.muted", cssVariable: "--theme-dark-muted", value: "#B0B0B8", usage: "dark mode secondary text" },
    { role: "theme.dark.faint", cssVariable: "--theme-dark-faint", value: "#8A8A92", usage: "dark mode metadata and subdued controls" },
    { role: "theme.dark.dim", cssVariable: "--theme-dark-dim", value: "#3F3F46", usage: "dark mode resting underlines and quiet dividers" },
    { role: "background.base", cssVariable: "--bg-base", value: "theme-aware", usage: "page canvas" },
    { role: "background.surface", cssVariable: "--bg-surface", value: "theme-aware", usage: "quiet panels and inputs" },
    { role: "background.element", cssVariable: "--bg-element", value: "theme-aware", usage: "resting underline, subtle UI fill, skeleton states" },
    { role: "border.light", cssVariable: "--border-light", value: "theme-aware", usage: "hairline structure only where needed" },
    { role: "text.primary", cssVariable: "--text-primary", value: "theme-aware", usage: "primary text and active links" },
    { role: "text.secondary", cssVariable: "--text-secondary", value: "theme-aware", usage: "secondary explanatory copy" },
    { role: "text.muted", cssVariable: "--text-muted", value: "theme-aware", usage: "metadata, tertiary copy, timestamps" },
    { role: "text.dim", cssVariable: "--text-dim", value: "theme-aware", usage: "resting underlines and low-emphasis strokes" },
  ],
  typography: {
    families: [
  ...
  elevation: [
    ...
    { role: "cursor", value: "small shadow only", usage: "custom cursor affordance, not layout surfaces" },
  ],
  motion: {
    durations: [
