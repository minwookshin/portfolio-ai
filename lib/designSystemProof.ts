...
export const DESIGN_SYSTEM_COMPONENTS = [
  ...
  },
  {
    ...
    description: "Hover and focus feedback starts inside the bullet cell, then gives nearby text a restrained 2px nudge: links and sections use the same small side-facing Material arrow, open sections rotate that exact arrow downward, section dots become a short leading stroke, and notes keep a quieter dot state.",
...
export const DESIGN_SYSTEM_INTERACTION_RULES = [
  ...
  "Keep open sections and open archive years on a stable filled dot at rest; when interacted with, rotate the same side-facing Material arrow downward instead of swapping to a separate down-arrow icon.",
  ...
  "Use signal families consistently: internal links draw the side-facing Material arrow, section rows rotate that same arrow by state, section dots become short strokes, notes keep dot-only feedback, and contact chips use lateral nudge plus cursor coupling.",
