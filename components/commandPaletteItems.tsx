  ...
  return [
    {
      ...
      title: "jump to interface board",
      meta: "atlas surfaces",
      group: "atlas",
      keywords: ["atlas", "interface", "artifact", "bento", "case study"],
      icon: <Hash />,
      preview: {
        title: "interface board",
        meta: "atlas",
        body: "DOM-built incident command, ER, field, and instruction surfaces.",
      },
      action: () => jumpToId("atlas-proof-bento", "/work/atlas#atlas-proof-bento"),
    },
    {
      id: "atlas-triage-map",
      title: "jump to incident command",
      meta: "atlas interface",
      group: "atlas",
      ...
      preview: {
        ...
        meta: "atlas interface",
        body: "A rebuilt command surface with rail, map state, and assignment UI.",
      },
      action: () => jumpToId("atlas-triage-map", "/work/atlas#atlas-triage-map"),
    },
    {
      id: "atlas-capacity-state",
      title: "jump to ER intake",
      meta: "atlas interface",
      group: "atlas",
      keywords: ["atlas", "capacity", "er", "hospital", "load"],
      icon: <Hash />,
      preview: {
        title: "ER intake",
        meta: "atlas interface",
        body: "Patient rows, load state, and intake detail in one surface.",
      },
    ...
    },
    {
      ...
      title: "jump to instruction loop",
      meta: "atlas interface",
      group: "atlas",
      ...
      preview: {
        ...
        meta: "atlas interface",
        body: "Quick actions and state feedback for command decisions.",
      },
