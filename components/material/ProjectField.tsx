        ...
        {projects.map((project, i) => {
          ...
          return (
            <button
              ...
              className={`absolute will-change-transform rounded-[18%] text-on-surface outline-none group focus-visible:ring-2 focus-visible:ring-on-surface focus-visible:ring-offset-2 focus-visible:ring-offset-surface ${isComingSoon ? "cursor-not-allowed" : ""}`}
              style={{
                width: iconSize,
                height: iconSize,
                left: -iconSize / 2,
            ...
            >
              <div className="w-full h-full rounded-[18%]" style={boxReveal}>
              <div
                className="relative w-full h-full rounded-[18%] overflow-hidden bg-transparent transition-transform duration-500 ease-[cubic-bezier(0.22,1,0.36,1)] group-hover:scale-95"
              >
                <div className="absolute inset-0 rounded-[18%]" style={revealStyle}>
                  {iconSrc ? (
                    <Image
                      src={iconSrc}
                      alt={project.title}
