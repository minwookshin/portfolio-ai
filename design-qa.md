...
- Patches made since previous QA pass: enlarged and centered the three section orbs, moved labels beneath each circle, removed the thick white orb border treatment, kept the selected label dropping into place below the orb, and saved desktop/mobile QA captures.
