  ...
  },
  {
    ...
    builder: {
      ...
      scope: [
        ...
        { label: "Test suite", value: "20 passing tests" },
        { label: "Static build", value: "59 generated pages" },
        { label: "AI-readable routes", value: "portfolio.md, llms.txt, resume.json, design-system.md, tokens.json" },
      ],
      results: [
        { label: "Actual", value: "Live production site" },
        { label: "Verification", value: "Public clone passes npm test, lint, typecheck, and build" },
      ],
    },
    features: [
      "Streaming responses using Server-Sent Events (SSE)",
      "Project routing tied to canonical case-study proof",
      "Machine-readable portfolio docs for recruiter and AI screening",
    ],
    challenges: "Bridging product storytelling, interface craft, and LLM behavior without letting the AI invent project proof.",
    outcome: "Turned a static portfolio into a live product demo with public source, structured AI-readable routes, and a compact design-system proof.",
  },
  {
    id: "11",
    slug: "atlas",
...
/>`,
  ...
  },
  {
    ...
    slug: "caret",
    title: "Caret",
    description: "iOS-style team wellbeing app concept presented through a public web prototype.",
    fullDescription: "Caret explores burnout signals, care actions, and collaborative recovery cues through an iOS-style product concept and public web prototype.",
    ...
    builder: {
      ...
      pipeline: "Designed in Figma → built as a public web presentation prototype.",
